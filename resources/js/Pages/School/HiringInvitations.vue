    ...
    <div>
      <div class="flex items-center justify-between mb-8 animate-fade-in-up">
        <div>
          ...
          <p class="text-slate-500 mt-1">متابعة حالة الدعوات المرسلة</p>
        </div>
      </div>
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  <template v-if="employment.status === 'invited'">
                    <button @click="rejectTeacher(employment.id)" class="btn-ghost text-xs px-3 py-1.5 text-red-600 hover:bg-red-50">
                      إلغاء الدعوة
                    </button>
                  </template>
          ...
          >
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  <template v-if="employment.status === 'invited'">
                    <button @click="rejectEmployee(employment.id)" class="btn-ghost text-xs px-3 py-1.5 text-red-600 hover:bg-red-50">
                      إلغاء الدعوة
                    </button>
                  </template>
...
const switchType = (type) => {
  ...
  router.get(`/school/hiring/invitations`, { type }, {
    preserveScroll: true,
    preserveState: true,
  })
}
