        ...
        <div class="overflow-x-auto">
          <table class="w-full">
            ...
            <tbody class="divide-y divide-surface-100">
              <tr v-for="(attachment, index) in filteredList" :key="attachment.id" class="hover:bg-primary-50/50 transition-colors">
...
const filteredList = computed(() => props.attachments.filter(item => matchesSearch(item, search.value)))
